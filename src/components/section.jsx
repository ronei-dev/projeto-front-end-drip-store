const Section = ({
    ...
    return (
        <section className="mb-12 px-4 md:px-8">
            <div
                className={`flex items-center mb-6 ${titleAlign === 'center' ? 'justify-center' : 'justify-between'
                    }`}
            >
                <h2
                    className={`${titleSize} font-semibold ${titleColor} ${titleAlign === 'center' ? 'text-center w-full' : ''
                        }`}
                >
                    {title}
                </h2>
