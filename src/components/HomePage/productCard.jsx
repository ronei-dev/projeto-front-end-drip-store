    ...
    return (
        <div className="flex flex-col border rounded-lg overflow-hidden shadow-md bg-white transition hover:shadow-lg w-full">
            <div className="relative h-56 md:h-60 flex items-center justify-center p-4">
                ...
                <img src={image} alt={`Imagem do produto ${name}`} className="max-h-40 md:max-h-44 object-contain" />
            </div>
            <div className="p-4 flex flex-col gap-2">
                ...
                <button onClick={handleCartClick} className={`mt-2 py-1 px-3 rounded text-sm transition font-semibold w-full ${isInCart
                ...
                <button onClick={handleViewMore} className="text-sm px-3 py-1 rounded bg-gray-200 text-gray-800 font-medium hover:bg-gray-300 mt-1">
                    Ver mais
                </button>
            </div>
        </div>
