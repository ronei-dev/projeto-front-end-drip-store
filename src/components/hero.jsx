...
const Hero = () => {
    ...
    return (
        <section className="relative overflow-hidden py-3 px-4 md:px-8 lg:px-16 bg-[#f0f0f0]">
            <div
                className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 w-100 h-150 md:w-125 md:h-150 bg-linear-to-t from-[#f0f0f0] to-white blur-2xl z-0">

            </div>

            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-[500px_auto] items-center gap-10 max-w-7xl mx-auto min-h-100">
                <div className="text-center lg:text-left max-w-225 mx-auto lg:mx-0 transition-all duration-300">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-neutral-900 leading-snug mb-6">
                        ...
                        <span className="inline-flex items-center gap-2">
                            Nike
                            {<img src={fireIcon} alt="Ícone de fogo" className="w-16 h-16 md:w-19 md:h-18 inline-block" />}
                        </span>
                    </h1>
                ...
                <div className="relative flex justify-center lg:justify-end items-center w-full">
                    <img src={current.image} alt={current.title} className="w-full object-contain drop-shadow-xl transition-all duration-300" />
                    {<img src={dotsImage} alt="Pontinhos decorativos" className="hidden md:block absolute -right-10 top-[10%] w-35 h-35 pointer-events-none" />}
                </div>
            </div>
