                ...
                <div className="grid grid-cols-5 gap-3">
                    {images.map((imgSrc, index) => (
                        <button
                            ...
                            className={`aspect-square w-full bg-gray-100 rounded-md overflow-hidden border-2 transition-all ${selectedIndex === index ? 'border-pink-500 shadow-md' : 'border-transparent hover:border-gray-300'}`}>
