    ...
    return (
        <div className="bg-white border border-gray-200 rounded-lg shadow-md flex flex-col justify-between transition-shadow hover:shadow-xl">
            ...
            <div className="p-4 flex flex-col grow">
                ...
                <h3 className="text-md font-semibold text-gray-800 mb-2 grow">{name}</h3>
            ...
            <div className="p-4 pt-0">
                <button
                    ...
                    className={`w-full text-white font-bold py-2 rounded-lg transition mb-2 ${isProductInCart ? 'bg-green-600 hover:bg-green-700' : 'bg-pink-600 hover:bg-pink-700'}`}>
